# flake.nix
#
# This file packages pythoneda-shared-iac/events-infrastructure as a Nix flake.
#
# Copyright (C) 2024-today rydnr's pythoneda-shared-iac/events-infrastructure
#
...
{
  description =
    "Nix flake for pythoneda-shared-iac/events-infrastructure";
  inputs = rec {
    ...
    pythoneda-shared-iac-events = {
      ...
      inputs.pythoneda-shared-pythonlang-domain.follows =
        "pythoneda-shared-pythonlang-domain";
      url = "github:pythoneda-shared-iac-def/events/0.0.32";
    };
  };
  outputs = inputs:
    with inputs;
    flake-utils.lib.eachDefaultSystem (system:
      let
        ...
        description =
          "Shared kernel for pythoneda-shared-iac/events-infrastructure";
        ...
        pythoneda-shared-iac-events-infrastructure-for = { python
          , pythoneda-shared-iac-events, pythoneda-shared-pythonlang-domain
          , pythoneda-shared-pythonlang-infrastructure }:
          let
          ...
          in python.pkgs.buildPythonPackage rec {
            ...
            pyprojectToml = pkgs.substituteAll {
              ...
              desc = description;
              inherit homepage package pname pythonMajorMinorVersion pythonpackage version;
              ...
              pythonedaSharedIacEvents =
                pythoneda-shared-iac-events.version;
            ...
            postInstall = with python.pkgs; ''
              ...
              for dep in ${pythoneda-shared-iac-events} ${pythoneda-shared-pythonlang-domain} ${pythoneda-shared-pythonlang-infrastructure}; do
      ...
      in rec {
        ...
        devShells = rec {
          default = pythoneda-shared-iac-events-infrastructure-python312;
          pythoneda-shared-iac-events-infrastructure-python39 =
            shared.devShell-for {
              banner = "${
              ...
              package =
                packages.pythoneda-shared-iac-events-infrastructure-python39;
          ...
          pythoneda-shared-iac-events-infrastructure-python310 =
            shared.devShell-for {
              banner = "${
              ...
              nixpkgs-release = nixpkgsRelease;
              package =
                packages.pythoneda-shared-iac-events-infrastructure-python310;
          ...
          pythoneda-shared-iac-events-infrastructure-python311 =
            shared.devShell-for {
              banner = "${
              ...
              nixpkgs-release = nixpkgsRelease;
              package =
                packages.pythoneda-shared-iac-events-infrastructure-python311;
          ...
          pythoneda-shared-iac-events-infrastructure-python312 =
            shared.devShell-for {
              banner = "${
              ...
              nixpkgs-release = nixpkgsRelease;
              package =
                packages.pythoneda-shared-iac-events-infrastructure-python312;
          ...
          pythoneda-shared-iac-events-infrastructure-python313 =
            shared.devShell-for {
              banner = "${
              ...
              nixpkgs-release = nixpkgsRelease;
              package =
                packages.pythoneda-shared-iac-events-infrastructure-python313;
        ...
        packages = rec {
          default = pythoneda-shared-iac-events-infrastructure-python312;
          pythoneda-shared-iac-events-infrastructure-python39 =
            pythoneda-shared-iac-events-infrastructure-for {
              python = pkgs.python39;
              pythoneda-shared-iac-events =
